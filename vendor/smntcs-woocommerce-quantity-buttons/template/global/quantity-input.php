...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity">
	 <div class="w-100 spinner">
		...
		<button type="button" class="minus btn btn-icon rounded-circle"><i data-feather="minus">-</i></button>
		...
		<button type="button" class="plus btn btn-icon rounded-circle"><i data-feather="plus">+</i></button>
