...
add_action( 'wp_enqueue_scripts', function() {
	//wp_enqueue_script( 'custom-script', get_stylesheet_directory_uri() . '/vendor/smntcs-woocommerce-quantity-buttons/custom.js', array('jquery'), false, true );
	wp_enqueue_style( 'custom-style', get_stylesheet_directory_uri() . '/vendor/smntcs-woocommerce-quantity-buttons/custom.css', null, false, 'screen' );
});
